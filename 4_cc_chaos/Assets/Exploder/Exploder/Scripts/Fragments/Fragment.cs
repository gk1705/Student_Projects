...
namespace Exploder
{
    ...
    public class Fragment : MonoBehaviour
    {
        ...
        public void ApplyExplosion(ExploderTransform meshTransform, Vector3 centroid, float force, GameObject original, ExploderParams set)
        {
	        ...
	        rigid.interpolation = settings.FragmentOptions.RigidbodyInterpolation;
	        rigid.drag = settings.FragmentOptions.Drag;
	        rigid.angularDrag = settings.FragmentOptions.AngularDrag;
        }

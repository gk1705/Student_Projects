...
public class SkidmarksManager : MonoBehaviour {
	...
	[SerializeField] float MARK_WIDTH = 0.35f; // Width of the skidmarks. Should match the width of the wheels
	[SerializeField] float GROUND_OFFSET = 0.02f;  // Distance above surface in metres
	[SerializeField] float MIN_DISTANCE = 0.25f; // Distance between skid texture sections in metres. Bigger = better performance, less smooth
